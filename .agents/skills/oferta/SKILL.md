...
**Um SaaS de API de IA com uso ilimitado.** O cliente paga uma mensalidade fixa e ganha acesso ilimitado (sem cobrança por token, sem quota de mensagens) aos melhores modelos frontier para código — Codex Fable 5.1, Opus 5, Sonnet 5, GPT-6 Astra e GLM 5.3 — via endpoints API compatíveis com Anthropic, OpenAI e Google SDKs, além de ferramentas como Codex, Codex CLI, Cursor, Continue, Aider e LangChain.
...
- Codex Fable 5.1, Opus 5, Sonnet 5, GPT-6 Astra e GLM 5.3
...
- Esta skill: `.Codex/skills/oferta/SKILL.md`